                        ...
                        <div class="cart-list">
                            <ul class="goods-list yui3-g">
                                ...
                                <li class="yui3-u-11-24">
                                    <div class="good-item">
                                        <div class="item-img"><img src="/static/index/img/_/s1.png" /></div>
...
{{--                </div>--}}
                <div class="sumbtn">
                    <a class="sum-btn" href="/index/create" target="_blank">生成订单</a>
                </div>
            </div>
        </div>
                    ...
                    <div id="myCarousel" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
                        <div class="carousel-inner">
                            <div class="active item">
                                <ul>
                                    <li>
                                        <img src="/static/index//static/index/img/like1.png" />
                                        <div class="intro">
                                    ...
                                    <li>
                                        <img src="/static/index//static/index/img/like2.png" />
                                        <div class="intro">
                                            <i>Apple苹果iPhone 6s (A1699)</i>
                                        </div>
                                        <div class="money">
                                    ...
                                    <li>
                                        <img src="/static/index//static/index/img/like3.png" />
                                        <div class="intro">
                                            <i>Apple苹果iPhone 6s (A1699)</i>
                                        </div>
                                        <div class="money">
                                    ...
                                    <li>
                                        <img src="/static/index//static/index/img/like4.png" />
                                        <div class="intro">
                                            <i>Apple苹果iPhone 6s (A1699)</i>
                                        </div>
                                        <div class="money">
        ...
        <div class="footlink">
            ...
            <div class="clearfix Mod-list">
                <div class="yui3-g">
                    ...
                    <div class="yui3-u-1-6">
                        <h4>帮助中心</h4>
                        <img src="/static/index//static/index/img/wx_cz.jpg">
                    </div>
                </div>
            </div>
